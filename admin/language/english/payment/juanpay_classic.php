<?php
// Heading
$_['heading_title']                     = 'JuanPay Classic Checkout';

// Text 
$_['text_payment']                      = 'Payment';
$_['text_success']                      = 'Success: You have modified JuanPay Classic Checkout account details!';
$_['text_juanpay_classic']                   = '<a href="https://www.juanpay.com/uk/mrb/pal=W9TBB5DTD6QJW" taget="_blank"><img src="view/image/payment/juanpay.png" alt="JuanPay" title="JuanPay" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_authorization']                = 'Authorization';
$_['text_sale']                         = 'Sale';
$_['text_clear']                        = 'Clear';
$_['text_browse']                       = 'Browse';
$_['text_image_manager']                = 'Image manager';
$_['text_dpn']                          = 'DPN url<span class="help">Required for subscriptions</span>';
...
// Error
$_['error_permission']                  = 'Warning: You do not have permission to modify payment JuanPay Classic Checkout!';
