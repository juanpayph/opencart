<?php 
class ControllerPaymentJuanPayClassic extends Controller {
	private $error = array(); 

	public function index() {
		$this->load->language('payment/juanpay_classic');

		$this->document->setTitle($this->language->get('heading_title'));
		
		$this->load->model('setting/setting');
        $this->load->model('setting/extension');
        $this->load->model('payment/juanpay_classic');

        $this->error = array();
			
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            unset($this->request->post['juanpay_classic_module']);

			$this->model_setting_setting->editSetting('juanpay_classic', $this->request->post);
        ...
        $this->data['text_dpn'] = $this->language->get('text_dpn');
		$this->data['text_dpn_url'] = HTTPS_CATALOG.'index.php?route=payment/juanpay_classic/dpn';
		...
		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('payment/juanpay_classic', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);

        //button actions
		$this->data['action'] = $this->url->link('payment/juanpay_classic', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], 'SSL');

        if (isset($this->request->post['juanpay_classic_username'])) {
			$this->data['juanpay_classic_username'] = $this->request->post['juanpay_classic_username'];
		} else {
			$this->data['juanpay_classic_username'] = $this->config->get('juanpay_classic_username');
		}

		if (isset($this->request->post['juanpay_classic_password'])) {
			$this->data['juanpay_classic_password'] = $this->request->post['juanpay_classic_password'];
		} else {
			$this->data['juanpay_classic_password'] = $this->config->get('juanpay_classic_password');
		}
		
		if (isset($this->request->post['juanpay_classic_signature'])) {
			$this->data['juanpay_classic_signature'] = $this->request->post['juanpay_classic_signature'];
		} else {
			$this->data['juanpay_classic_signature'] = $this->config->get('juanpay_classic_signature');
		}

		if (isset($this->request->post['juanpay_classic_test'])) {
			$this->data['juanpay_classic_test'] = $this->request->post['juanpay_classic_test'];
		} else {
			$this->data['juanpay_classic_test'] = $this->config->get('juanpay_classic_test');
		}

		if (isset($this->request->post['juanpay_classic_method'])) {
			$this->data['juanpay_classic_method'] = $this->request->post['juanpay_classic_method'];
		} else {
			$this->data['juanpay_classic_method'] = $this->config->get('juanpay_classic_method');
		}

		if (isset($this->request->post['juanpay_classic_total'])) {
			$this->data['juanpay_classic_total'] = $this->request->post['juanpay_classic_total'];
		} else {
			$this->data['juanpay_classic_total'] = $this->config->get('juanpay_classic_total');
		}

        if (isset($this->request->post['juanpay_classic_debug'])) {
            $this->data['juanpay_classic_debug'] = $this->request->post['juanpay_classic_debug'];
        } else {
            $this->data['juanpay_classic_debug'] = $this->config->get('juanpay_classic_debug');
        }

        if (isset($this->request->post['juanpay_classic_currency'])) {
            $this->data['juanpay_classic_currency'] = $this->request->post['juanpay_classic_currency'];
        } else {
            $this->data['juanpay_classic_currency'] = $this->config->get('juanpay_classic_currency');
        }

        $this->data['currency_codes'] = $this->model_payment_juanpay_classic->currencyCodes();

        $this->load->model('localisation/order_status');

        $this->data['order_statuses'] = $this->model_localisation_order_status->getOrderStatuses();

        if (isset($this->request->post['juanpay_classic_canceled_reversal_status_id'])) {
            $this->data['juanpay_classic_canceled_reversal_status_id'] = $this->request->post['juanpay_classic_canceled_reversal_status_id'];
        } else {
            $this->data['juanpay_classic_canceled_reversal_status_id'] = $this->config->get('juanpay_classic_canceled_reversal_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_completed_status_id'])) {
            $this->data['juanpay_classic_completed_status_id'] = $this->request->post['juanpay_classic_completed_status_id'];
        } else {
            $this->data['juanpay_classic_completed_status_id'] = $this->config->get('juanpay_classic_completed_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_denied_status_id'])) {
            $this->data['juanpay_classic_denied_status_id'] = $this->request->post['juanpay_classic_denied_status_id'];
        } else {
            $this->data['juanpay_classic_denied_status_id'] = $this->config->get('juanpay_classic_denied_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_expired_status_id'])) {
            $this->data['juanpay_classic_expired_status_id'] = $this->request->post['juanpay_classic_expired_status_id'];
        } else {
            $this->data['juanpay_classic_expired_status_id'] = $this->config->get('juanpay_classic_expired_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_failed_status_id'])) {
            $this->data['juanpay_classic_failed_status_id'] = $this->request->post['juanpay_classic_failed_status_id'];
        } else {
            $this->data['juanpay_classic_failed_status_id'] = $this->config->get('juanpay_classic_failed_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_pending_status_id'])) {
            $this->data['juanpay_classic_pending_status_id'] = $this->request->post['juanpay_classic_pending_status_id'];
        } else {
            $this->data['juanpay_classic_pending_status_id'] = $this->config->get('juanpay_classic_pending_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_processed_status_id'])) {
            $this->data['juanpay_classic_processed_status_id'] = $this->request->post['juanpay_classic_processed_status_id'];
        } else {
            $this->data['juanpay_classic_processed_status_id'] = $this->config->get('juanpay_classic_processed_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_refunded_status_id'])) {
            $this->data['juanpay_classic_refunded_status_id'] = $this->request->post['juanpay_classic_refunded_status_id'];
        } else {
            $this->data['juanpay_classic_refunded_status_id'] = $this->config->get('juanpay_classic_refunded_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_reversed_status_id'])) {
            $this->data['juanpay_classic_reversed_status_id'] = $this->request->post['juanpay_classic_reversed_status_id'];
        } else {
            $this->data['juanpay_classic_reversed_status_id'] = $this->config->get('juanpay_classic_reversed_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_voided_status_id'])) {
            $this->data['juanpay_classic_voided_status_id'] = $this->request->post['juanpay_classic_voided_status_id'];
        } else {
            $this->data['juanpay_classic_voided_status_id'] = $this->config->get('juanpay_classic_voided_status_id');
        }
        
        if (isset($this->request->post['juanpay_classic_allow_note'])) {
            $this->data['juanpay_classic_allow_note'] = $this->request->post['juanpay_classic_allow_note'];
        } else {
            $this->data['juanpay_classic_allow_note'] = $this->config->get('juanpay_classic_allow_note');
        }
        
        if (isset($this->request->post['juanpay_classic_logo'])) {
            $this->data['juanpay_classic_logo'] = $this->request->post['juanpay_classic_logo'];
        } else {
            $this->data['juanpay_classic_logo'] = $this->config->get('juanpay_classic_logo');
        }
        
        if (isset($this->request->post['juanpay_classic_border_colour'])) {
            $this->data['juanpay_classic_border_colour'] = str_replace('#', '', $this->request->post['juanpay_classic_border_colour'] );
        } else {
            $this->data['juanpay_classic_border_colour'] = $this->config->get('juanpay_classic_border_colour');
        }
        
        if (isset($this->request->post['juanpay_classic_header_colour'])) {
            $this->data['juanpay_classic_header_colour'] = str_replace('#', '', $this->request->post['juanpay_classic_header_colour'] );
        } else {
            $this->data['juanpay_classic_header_colour'] = $this->config->get('juanpay_classic_header_colour');
        }
        
        if (isset($this->request->post['juanpay_classic_page_colour'])) {
            $this->data['juanpay_classic_page_colour'] = str_replace('#', '', $this->request->post['juanpay_classic_page_colour'] );
        } else {
            $this->data['juanpay_classic_page_colour'] = $this->config->get('juanpay_classic_page_colour');
        }
        
        if (isset($this->request->post['juanpay_classic_profile_cancel_status'])) {
            $this->data['juanpay_classic_profile_cancel_status'] = $this->request->post['juanpay_classic_profile_cancel_status'];
        } else {
            $this->data['juanpay_classic_profile_cancel_status'] = $this->config->get('juanpay_classic_profile_cancel_status');
        }

        $this->load->model('tool/image');

        $logo = $this->config->get('juanpay_classic_logo');

        if (isset($this->request->post['juanpay_classic_logo']) && file_exists(DIR_IMAGE . $this->request->post['juanpay_classic_logo'])) {
            $this->data['thumb'] = $this->model_tool_image->resize($this->request->post['juanpay_classic_logo'], 750, 90);
        ...
        if (isset($this->request->post['juanpay_classic_geo_zone_id'])) {
			$this->data['juanpay_classic_geo_zone_id'] = $this->request->post['juanpay_classic_geo_zone_id'];
		} else {
			$this->data['juanpay_classic_geo_zone_id'] = $this->config->get('juanpay_classic_geo_zone_id');
		}
		...
		if (isset($this->request->post['juanpay_classic_status'])) {
			$this->data['juanpay_classic_status'] = $this->request->post['juanpay_classic_status'];
		} else {
			$this->data['juanpay_classic_status'] = $this->config->get('juanpay_classic_status');
		}

		if (isset($this->request->post['juanpay_classic_sort_order'])) {
			$this->data['juanpay_classic_sort_order'] = $this->request->post['juanpay_classic_sort_order'];
		} else {
			$this->data['juanpay_classic_sort_order'] = $this->config->get('juanpay_classic_sort_order');
		}

        $this->data['token'] = $this->session->data['token'];

		$this->template = 'payment/juanpay_classic.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);		
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'payment/juanpay_classic')) {
			$this->error['warning'] = $this->language->get('error_permission');
		}
		
		if (empty($this->request->post['juanpay_classic_username'])) {
			$this->error['username'] = $this->language->get('error_username');
		}

		if (empty($this->request->post['juanpay_classic_password'])) {
			$this->error['password'] = $this->language->get('error_password');
		}

        if (empty($this->request->post['juanpay_classic_signature'])) {
    ...
    public function resend() {
            ...
            if (isset($this->request->get['juanpay_order_transaction_id'])) {
                $transaction = $this->model_payment_juanpay_classic->getFailedTransaction($this->request->get['juanpay_order_transaction_id']);
                
                if ($transaction) {
                    $call_data = unserialize($transaction['call_data']);
                    
                    $result = $this->model_payment_juanpay_classic->call($call_data);
                    
                    if ($result) {

                        $parent_transaction = $this->model_payment_juanpay_classic->getLocalTransaction($transaction['parent_transaction_id']);
                        
                        if ($parent_transaction['amount'] == abs($transaction['amount'])) {
                            $this->db->query("UPDATE `" . DB_PREFIX . "juanpay_order_transaction` SET `payment_status` = 'Refunded' WHERE `transaction_id` = '" . $this->db->escape($transaction['parent_transaction_id']) . "' LIMIT 1");
                        } else {
                            $this->db->query("UPDATE `" . DB_PREFIX . "juanpay_order_transaction` SET `payment_status` = 'Partially-Refunded' WHERE `transaction_id` = '" . $this->db->escape($transaction['parent_transaction_id']) . "' LIMIT 1");
                        }
                        ...
                        $this->model_payment_juanpay_classic->updateTransaction($transaction);
    ...
    public function capture() {
        ...
        if(isset($this->request->post['order_id']) && $this->request->post['amount'] > 0 && isset($this->request->post['order_id']) && isset($this->request->post['complete'])) {
            ...
            $juanpay_order = $this->model_payment_juanpay_classic->getOrder($this->request->post['order_id']);
            ...
            $call_data['AUTHORIZATIONID'] = $juanpay_order['authorization_id'];
            $call_data['AMT'] = number_format($this->request->post['amount'], 2);
            $call_data['CURRENCYCODE'] = $juanpay_order['currency_code'];
            ...
            $transaction = array(
                'juanpay_order_id' => $juanpay_order['juanpay_order_id'],
                'transaction_id' => '',
                'parent_transaction_id' => $juanpay_order['authorization_id'],
                'note' => '',
            ...
            if ($result == false) {
                ...
                $juanpay_order_transaction_id = $this->model_payment_juanpay_classic->addTransaction($transaction, $call_data);
                
                $json['error'] = true;
                
                $json['failed_transaction']['juanpay_order_transaction_id'] = $juanpay_order_transaction_id;
                ...
                $this->model_payment_juanpay_classic->addTransaction($transaction);

                unset($transaction['debug_data']);
                $transaction['created'] = date("Y-m-d H:i:s");

                $captured = number_format($this->model_payment_juanpay_classic->totalCaptured($juanpay_order['juanpay_order_id']), 2);
                $refunded = number_format($this->model_payment_juanpay_classic->totalRefundedOrder($juanpay_order['juanpay_order_id']), 2);

                $transaction['captured'] = $captured;
                $transaction['refunded'] = $refunded;
                $transaction['remaining'] = number_format($juanpay_order['total'] - $captured, 2);

                $transaction['status'] = 0;
                if($transaction['remaining'] == 0.00) {
                    $transaction['status'] = 1;
                    $this->model_payment_juanpay_classic->updateOrder('Complete', $this->request->post['order_id']);
                }
                ...
                if($this->request->post['complete'] == 1 && $transaction['remaining'] > 0) {
                    ...
                    $this->model_payment_juanpay_classic->addTransaction($transaction['void']);
                    $this->model_payment_juanpay_classic->updateOrder('Complete', $this->request->post['order_id']);
    ...
    public function refund() {
        ...
        $this->load->language('payment/juanpay_classic_refund');
        ...
        $this->data['breadcrumbs'][] = array(
            'text'      => $this->language->get('text_juanpay_classic'),
            'href'      => $this->url->link('payment/juanpay_classic', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );
        ...
        $this->data['breadcrumbs'][] = array(
            'text'      => $this->language->get('heading_title'),
            'href'      => $this->url->link('payment/juanpay_classic/refund', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );

        //button actions
        $this->data['action'] = $this->url->link('payment/juanpay_classic/doRefund', 'token=' . $this->session->data['token'], 'SSL');
        $this->data['cancel'] = $this->url->link('payment/juanpay_classic', 'token=' . $this->session->data['token'], 'SSL');

        $this->data['transaction_id'] = $this->request->get['transaction_id'];

        $this->load->model('payment/juanpay_classic');
        $pp_transaction = $this->model_payment_juanpay_classic->getTransaction($this->request->get['transaction_id']);

        $this->data['amount_original'] = $pp_transaction['AMT'];
        $this->data['currency_code'] = $pp_transaction['CURRENCYCODE'];

        $refunded = number_format($this->model_payment_juanpay_classic->totalRefundedTransaction($this->request->get['transaction_id']), 2);
        ...
        $this->template = 'payment/juanpay_classic_refund.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    public function doRefund() {
        ...
        if(isset($this->request->post['transaction_id']) && isset($this->request->post['refund_full'])) {
            ...
            if($this->request->post['refund_full'] == 0 && $this->request->post['amount'] == 0) {
                ...
                $order_id = $this->model_payment_juanpay_classic->getOrderId($this->request->post['transaction_id']);
                $juanpay_order = $this->model_payment_juanpay_classic->getOrder($order_id);
                ...
                if ($juanpay_order) {
                    ...
                    $current_transaction = $this->model_payment_juanpay_classic->getLocalTransaction($this->request->post['transaction_id']);
                    ...
                    if ($result == false) {
                        ...
                        $this->model_payment_juanpay_classic->addTransaction($transaction, $call_data);
                        $this->redirect($this->url->link('sale/order/info', 'token=' . $this->session->data['token'] . '&order_id=' . $juanpay_order['order_id'], 'SSL'));
                        ...
                        if ($result['TOTALREFUNDEDAMOUNT'] == $this->request->post['amount_original']) {
                            $this->db->query("UPDATE `" . DB_PREFIX . "juanpay_order_transaction` SET `payment_status` = 'Refunded' WHERE `transaction_id` = '" . $this->db->escape($this->request->post['transaction_id']) . "' LIMIT 1");
                        } else {
                            $this->db->query("UPDATE `" . DB_PREFIX . "juanpay_order_transaction` SET `payment_status` = 'Partially-Refunded' WHERE `transaction_id` = '" . $this->db->escape($this->request->post['transaction_id']) . "' LIMIT 1");
                        }

                        //redirect back to the order
                        $this->redirect($this->url->link('sale/order/info', 'token=' . $this->session->data['token'] . '&order_id=' . $juanpay_order['order_id'], 'SSL'));
                    } else {
                        $this->model_payment_juanpay_classic->log(json_encode($result));
                        ...
                        $this->redirect($this->url->link('payment/juanpay_classic/refund', 'token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->post['transaction_id'], 'SSL'));
                    }
                } else {
    ...
    public function install() {
        $this->load->model('payment/juanpay_classic');
        $this->model_payment_juanpay_classic->install();
    }

    public function uninstall() {
        $this->load->model('payment/juanpay_classic');
        $this->model_payment_juanpay_classic->uninstall();
    }

    public function orderAction() {
        if ($this->config->get('juanpay_classic_status')) {
            $this->load->model('payment/juanpay_classic');
            $this->load->language('payment/juanpay_classic_order');

            $juanpay_order = $this->model_payment_juanpay_classic->getOrder($this->request->get['order_id']);
            ...
            if ($juanpay_order) {
                ...
                $this->data['juanpay_order'] = $juanpay_order;
                $this->data['order_id'] = $this->request->get['order_id'];
                $this->data['token'] = $this->session->data['token']; 

                $captured = number_format($this->model_payment_juanpay_classic->totalCaptured($this->data['juanpay_order']['juanpay_order_id']), 2);
                $refunded = number_format($this->model_payment_juanpay_classic->totalRefundedOrder($this->data['juanpay_order']['juanpay_order_id']), 2);

                $this->data['juanpay_order']['captured'] = $captured;
                $this->data['juanpay_order']['refunded'] = $refunded;
                $this->data['juanpay_order']['remaining'] = number_format($this->data['juanpay_order']['total'] - $captured, 2);
                ...
                if ($juanpay_order) {
                    ...
                    $this->data['juanpay_order']['captured'] = $captured;
                    $this->data['juanpay_order']['refunded'] = $refunded;
                    $this->data['juanpay_order']['remaining'] = number_format($juanpay_order['total'] - $captured, 2);
                }

                $this->data['refund_link'] = $this->url->link('payment/juanpay_classic/refund', 'token=' . $this->session->data['token'], 'SSL');
                $this->data['view_link'] = $this->url->link('payment/juanpay_classic/viewTransaction', 'token=' . $this->session->data['token'], 'SSL');
                $this->data['resend_link'] = $this->url->link('payment/juanpay_classic/resend', 'token=' . $this->session->data['token'], 'SSL');

                $this->template = 'payment/juanpay_classic_order.tpl';
                $this->response->setOutput($this->render());
            }
        }
    }
    ...
    public function search() {
        ...
        $this->load->language('payment/juanpay_classic_search');
        $this->load->model('payment/juanpay_classic');
        ...
        $this->data['currency_codes'] = $this->model_payment_juanpay_classic->currencyCodes();
        $this->data['default_currency'] = $this->config->get('juanpay_classic_currency');
        ...
        $this->data['breadcrumbs'][] = array(
            'text'      => $this->language->get('heading_title'),
            'href'      => $this->url->link('payment/juanpay_classic/search', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );
        ...
        $this->template = 'payment/juanpay_classic_search.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    public function viewTransaction() {
        $this->load->model('payment/juanpay_classic');
        $this->load->language('payment/juanpay_classic_view');

        $this->data['transaction'] = $this->model_payment_juanpay_classic->getTransaction($this->request->get['transaction_id']);
        ...
        $this->data['breadcrumbs'][] = array(
            'text'      => $this->language->get('heading_title'),
            'href'      => $this->url->link('payment/juanpay_classic/viewTransaction', 'token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->get['transaction_id'], 'SSL'),
            'separator' => ' :: '
        );

        $this->template = 'payment/juanpay_classic_view.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
    ...
    public function recurringCancel() {
        ...
        if($profile && !empty($profile['profile_reference'])) {
            ...
            $result = $this->model_payment_juanpay_classic->recurringCancel($profile['profile_reference']);
